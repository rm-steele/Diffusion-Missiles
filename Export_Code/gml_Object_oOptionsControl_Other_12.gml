...
if global.opdiffchargestyle
    op[10].optext = "Fusion"
else
    op[10].optext = "Classic"
if (global.curropt == 10)
{
    if global.opdiffchargestyle
        global.tiptext = "Arm your Super Missiles to charge Diffusions"
    else
        global.tiptext = "Hold Fire with Super Missiles readied to charge Diffusions"
}
