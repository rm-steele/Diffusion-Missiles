...
if drawlines
{
    ...
    {
        draw_sprite_ext(sSubScrHilight, -1, (x - 28), (y - 55), 1, 1, 0, -1, halpha)
        draw_line((x + 34), (y - 53), (x + 50), (y - 53))
        draw_line((x + 50), (y - 53), (oSubScrPlayer.x - 33), (oSubScrPlayer.y + 81))
...
draw_text((x + 1 - 30), (y + 4 - 72 + oControl.subScrHeaderOffset), beam)
draw_set_color(c_white)
draw_text((x - 30), (y + 3 - 72 + oControl.subScrHeaderOffset), beam)
