if (active && oControl.kDown && oControl.kDownPushedSteps == 0)
{
    if (global.curropt == 2)
        global.curropt = 17
    else if (global.curropt == 17)
        global.curropt = 3
    else if (global.curropt == 16)
        global.curropt = 0
    else
        global.curropt += 1
    ...
    if (global.curropt == 2 && global.item[9] == 0)
        global.curropt = 17
    if (global.curropt == 17 && global.item[256] == 0)
        global.curropt = 3
...
if (active && oControl.kRight > 0 && oControl.kRightPushedSteps == 0 && (global.curropt < 8 || global.curropt == 17))
{
...
if (active && oControl.kLeft > 0 && oControl.kLeftPushedSteps == 0 && global.curropt >= 8 && global.curropt != 17)
{
    ...
    if (global.curropt == 7 && global.item[11] == 0)
        global.curropt += 1
    if (global.curropt > 7 && global.curropt != 17)
        global.curropt = 0
    sfx_play(sndMenuMove)
}
...
if editing
{
    ...
    if (global.curropt == 17)
        global.diffusionmissiles = (!global.diffusionmissiles)
    if (global.curropt == 3)
...
if (global.curropt < 14 || global.curropt == 17)
